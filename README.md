...
🎮 **Aspiring Game Developer | Gameplay Programmer | Creative Technologist**
...
- 🧰 Exploring interactive systems and player experience design
- 🎨 Creating 2D/3D assets and environments using **Blender**, **PowerPoint**, **Word**, and **HTML/CSS**

## 🛠️ Technical Skills
- **Game Engines:** Unity, Unreal Engine
- **Languages:** C#, C++, HTML, CSS
- **Tools:** Blender 3.6, GitHub, Microsoft Office (Excel, PowerPoint, Word)
- **Other:** 3D mapping, site design, access control documentation, training manual development

## 💼 Professional Background
I’ve spent the last 3+ years working in security and access control, where I:
- Created 3D interior building maps with Blender for facility planning
...
- Collaborate with other developers on creative, meaningful games
- Keep learning, building, and sharing my journey through GitHub

---

### 📫 Let's Connect!
- 🌐 [LinkedIn](https://www.linkedin.com/in/RollinsJoshworks)
- ✉️ Email: rollinsjoshworks@gmail.com
